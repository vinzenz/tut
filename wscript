...
# install -> create simple tut_config script with compilation parameters -> g++ .... `tut_config`
# echo -g -lftrace -lcppreflection -ldw -lelf -lunwind -finstrument-functions -fno-inline -funwind-tables -fasynchronous-unwind-tables -fno-eliminate-unused-debug-types
